...
const Crousal = () => {
  return (
    <>
      <div className="coursal_container">
        ...
        <div className="sliders">
          <img
            src="https://assets.myntassets.com/w_980,c_limit,fl_progressive,dpr_2.0/assets/images/2024/2/21/b58b523f-4643-4871-a526-3ac9fa0e3bc21708517776346-Roadster_DekstopBanner.jpg"
            alt=""
          />
        </div>
        <div className="sliders">
